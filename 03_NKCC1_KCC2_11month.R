...
result_NKCC1 <- plot_gene_violin(seurat, gene = "SLC12A2", gene_label = "NKCC1 (SLC12A2)", cell_type_col = "cell")
result_KCC2  <- plot_gene_violin(seurat, gene = "SLC12A5", gene_label = "KCC2 (SLC12A5)",  cell_type_col = "cell")

pdf("/home/jchen/data1/jchen/project/01_sarah_proj/05_organoids/02_results/02_check_genes/plots/11mo_nkcc1_kcc2_subtype.pdf", width = 11, height = 7)
...
result_nkcc1_diagnosis <- plot_gene_by_diagnosis(seurat_neuron, gene = "SLC12A2", gene_label = "NKCC1 (SLC12A2)",
                                                  cell_type_col = "cell", diagnosis_col = "diagnosis")
result_kcc2_diagnosis  <- plot_gene_by_diagnosis(seurat_neuron, gene = "SLC12A5", gene_label = "KCC2 (SLC12A5)",
                                                  cell_type_col = "cell", diagnosis_col = "diagnosis")

pdf("/home/jchen/data1/jchen/project/01_sarah_proj/05_organoids/02_results/02_check_genes/plots/11mo_nkcc1_kcc2_subtype_diagnosis.pdf", width = 10, height = 7)
...
exc <- subset(seurat, subset = cell %in% c("Excitatory 1", "Excitatory 2"))
...
pseudo <- df %>%
  group_by(patient_id, diagnosis, cell) %>%
  summarise(
    n_cells = n(),
...
pdf("/raidixshare_logg01/jchen/project/01_sarah_proj/05_organoids/02_results/02_check_genes/comparing_NKCC1_KCC2_boxplots/11mo_NKCC1_KCC2_EXC_boxplot.pdf", width = 10, height = 4)
p_exc1 + p_exc2
dev.off()
