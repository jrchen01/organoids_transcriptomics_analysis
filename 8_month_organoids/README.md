...
All analyses were performed in R (version 4.2.2) under CentOS Linux 7 (Core) using conda environment. The complete output of `sessionInfo()` for both the general scRNA‑seq analyses and the cell–cell communication analyses are shown below:
